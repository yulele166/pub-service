package com.eauto100.pub.service.framework.eop;

import java.util.Map;

import javax.servlet.http.HttpServletRequest;

import com.eauto100.pub.service.framework.context.SpringContextHolder;
import com.eauto100.pub.service.framework.context.ThreadContextHolder;
import com.eauto100.pub.service.framework.service.ISettingService;
import com.eauto100.pub.service.framework.util.RequestUtil;
...
public class SystemSetting {
	...
	private static String static_email_path;	//静态邮件路径
	...
	public static void load(){
		...
		static_email_path = settings.get("static_email_path");
	...
	public static String getStatic_email_path() {
		return static_email_path;
	}


	public static void setStatic_email_path(String static_email_path) {
		SystemSetting.static_email_path = static_email_path;
	}
